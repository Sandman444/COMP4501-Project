...
public class GameController : MonoBehaviour
{
    ...
    void Start()
    {
      ...
      CreateUnit(UnitType.Land, User.Player, new Vector3(0, 1, 0));
        ...
        CreateUnit(UnitType.Flying, User.Player, new Vector3(0, 7.5f, 2));
        CreateUnit(UnitType.Flying, User.Player, new Vector3(2, 7.5f, 2));
        CreateUnit(UnitType.Flying, User.Player, new Vector3(4, 7.5f, 2));
        CreateUnit(UnitType.Flying, User.Player, new Vector3(6, 7.5f, 2));
        CreateUnit(UnitType.Flying, User.Player, new Vector3(8, 7.5f, 2));
